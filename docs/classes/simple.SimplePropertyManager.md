...
- [entries](simple.SimplePropertyManager.md#entries)
...
- [getOwnPropertyDescriptors](simple.SimplePropertyManager.md#getownpropertydescriptors)
...
- [values](simple.SimplePropertyManager.md#values)
